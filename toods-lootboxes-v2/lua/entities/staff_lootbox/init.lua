...
function ENT:Use( ply )
    ...
    if IsValid( ply ) && ply:IsPlayer() then
		...
		local getitem = table.Random( Loot.RareStaffs )
		local dirandxp = table.Random( Loot.RareStaffXP )
		...
		local getitem2 = table.Random( Loot.CommonStaffs )
		local randxp = table.Random( Loot.CommonStaffXP )
