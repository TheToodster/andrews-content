...
function ENT:Use( ply )
    ...
    if IsValid( ply ) && ply:IsPlayer() then
		...
		local getitem = table.Random( Loot.RareHilts )
		local advrandxp = table.Random( Loot.RareHiltXP )
		...
		local getitem2 = table.Random( Loot.CommonHilts )
		local randxp = table.Random( Loot.CommonHiltXP )
