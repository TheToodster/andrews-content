...
function ENT:Use( ply )
    ...
    if IsValid( ply ) && ply:IsPlayer() then
		...
		local getitem = table.Random( Loot.RareUnstable )
		local dirandxp = table.Random( Loot.RareUnstableXP )
		...
		local getitem2 = table.Random( Loot.CommonUnstable )
		local randxp = table.Random( Loot.CommonUnstableXP )
