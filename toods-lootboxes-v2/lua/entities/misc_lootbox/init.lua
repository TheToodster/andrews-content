...
function ENT:Use( ply )
    ...
    if IsValid( ply ) && ply:IsPlayer() then
		...
		local getitem = table.Random( Loot.MiscItems )
		local advrandxp = table.Random( Loot.RareMiscXP )
		...
		local getitem2 = table.Random( Loot.MiscSounds )
		local randxp = table.Random( Loot.CommonMiscXP )
