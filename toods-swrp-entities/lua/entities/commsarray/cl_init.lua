...
function ENT:Draw()
	...
	if LocalPlayer():GetPos():DistToSqr( self:GetPos() ) < 512 * 512 then
		cam.Start3D2D( p + Vector( 0, 0, 10 ), Angle( 0, ang.y, 90 ), .15 )
			draw.RoundedBox( 5, - 180, - 750, 350, 50, Color( 0, 0, 0, 230 ) )
			draw.RoundedBox( 5, - 180 + 2, - 750 + 2, math.Clamp( self:Health() / self:GetMaxHealth() * 350, 0, 350 ), 50 - 2, Color( 150, 0, 0, 230 ) )
